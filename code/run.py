...
if __name__ == "__main__":
    ...
    test_cem_gt_dynamics(50)    # Q1.1 #True environment Dynamics
    train_single_dynamics(50, device=device)   # Q1.2 #Learned Model
    train_pets(device=device)  # Q1.3 #Trains Ensemble Model 
